...
const appRoute : Routes = [
  ...
  {path: 'panel', children : [
    ...
    {path:'variedades/inventario/:id', component: VariedadProductoComponent,canActivate  : [AdminGuard]},

    {path:'variedades/galeria/:id', component: GaleriaProductoComponent,canActivate  : [AdminGuard]},
